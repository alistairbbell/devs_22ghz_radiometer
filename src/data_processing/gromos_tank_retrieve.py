...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 25 15:55:38 2024
...
server_basepath = '/instruments/gromos/level2/GROMORA/v3/'  # Assuming root share access, adjust as needed
...
#output_file_name = 'MIAWARA_C_concat_H2O_2018_2024_rescaled_v4.nc'
output_file_name = 'gromos_concat_H2O_2022_2024_rescaled_ndacc_v2.nc'
...
vars_to_drop = ['lon', 'lat','y', 'yf', 'tropospheric_opacity', 'J', 'f', 'A', 'q_err_smooth', 'z',
                'o3_avkm', 'o3_fwhm',  'o3_offset', 'freq_shift_x', 'freq_shift_xa',
                'freq_shift_mr', 'f_shift_grid', 'bad_channels',  'y_baseline',
                ]
...
for year in years_s:
    ...
    for file in files:
        print(file.filename)
        if h2o_string in file.filename and file.filename.endswith("v21.nc"):
